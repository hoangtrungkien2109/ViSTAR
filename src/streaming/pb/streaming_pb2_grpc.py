...
class StreamingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.BatchPushImage = channel.unary_unary(
                '/streaming_services.Streaming/BatchPushImage',
                request_serializer=streaming__pb2.BatchPushImageRequest.SerializeToString,
                response_deserializer=streaming__pb2.BatchPushImageResponse.FromString,
                )
        self.BatchPopImage = channel.unary_stream(
                '/streaming_services.Streaming/BatchPopImage',
                request_serializer=streaming__pb2.BatchPopImageRequest.SerializeToString,
                response_deserializer=streaming__pb2.BatchPopImageResponse.FromString,
                )
...
def add_StreamingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'BatchPushImage': grpc.unary_unary_rpc_method_handler(
                    servicer.BatchPushImage,
                    request_deserializer=streaming__pb2.BatchPushImageRequest.FromString,
                    response_serializer=streaming__pb2.BatchPushImageResponse.SerializeToString,
            ),
            'BatchPopImage': grpc.unary_stream_rpc_method_handler(
                    servicer.BatchPopImage,
                    request_deserializer=streaming__pb2.BatchPopImageRequest.FromString,
                    response_serializer=streaming__pb2.BatchPopImageResponse.SerializeToString,
            ),
    }
...
class Streaming(object):
    ...
    def BatchPushImage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/streaming_services.Streaming/BatchPushImage',
            streaming__pb2.BatchPushImageRequest.SerializeToString,
            streaming__pb2.BatchPushImageResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def BatchPopImage(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/streaming_services.Streaming/BatchPopImage',
            streaming__pb2.BatchPopImageRequest.SerializeToString,
            streaming__pb2.BatchPopImageResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
